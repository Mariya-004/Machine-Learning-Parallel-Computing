...
# ---------------- PREP DATA ----------------
X_train = x_train.reshape(x_train.shape[0], -1) #flatten the image changes 28*28 to one row of 784 elements
X_test  = x_test.reshape(x_test.shape[0], -1)

y_train_lbl = np.argmax(y_train, axis=1) # CONVERTS ONE HOT ENCODING BACK TO NUMERICAL
...
grid.fit(X_sub, y_sub) #trains model with different c values, finds best one and prints it
